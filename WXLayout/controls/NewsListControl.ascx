<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsListControl.ascx.cs" Inherits="WXLayout.controls.NewsListControl" %>
<div class="box box-element ui-draggable" asp-uc="NewsListControl" asp-properties="Content">
