<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewLogoControl.ascx.cs" Inherits="WXLayout.controls.NewLogoControl" %>
<div class="box box-element ui-draggable" asp-uc="NewLogoControl" asp-properties="Content">
