<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="banner.ascx.cs" Inherits="WXLayout.controls.banner" %>

<div class="box box-element ui-draggable" asp-uc="uc1:banner1" asp-properties="Content">
