<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageNewsControl.ascx.cs" Inherits="WXLayout.controls.ImageNewsControl" %>
<div class="box box-element ui-draggable" asp-uc="ImageNewsControl" asp-properties="Content">
    ...
    <div class="preview">图片新闻控件</div>
    <div class="view">
        <section asp-uc="ImageNewsControl">
        图片新闻控件
