<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleImageControl.ascx.cs" Inherits="WXLayout.controls.SingleImageControl" %>
<div class="box box-element ui-draggable" asp-uc="SingleImageControl" asp-properties="Content">
