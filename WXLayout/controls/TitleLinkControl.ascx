<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TitleLinkControl.ascx.cs" Inherits="WXLayout.controls.TitleLinkControl" %>
<div class="box box-element ui-draggable" asp-uc="TitleLinkControl" asp-properties="Content">
