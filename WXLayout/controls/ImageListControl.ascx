<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageListControl.ascx.cs" Inherits="WXLayout.controls.ImageListControl" %>
<div class="box box-element ui-draggable" asp-uc="ImageListControl" asp-properties="Content">
