<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiImageControl.ascx.cs" Inherits="WXLayout.controls.MultiImageControl" %>
<div class="box box-element ui-draggable" asp-uc="MultiImageControl" asp-properties="Content">
