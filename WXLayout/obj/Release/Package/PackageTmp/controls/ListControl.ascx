<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListControl.ascx.cs" Inherits="WXLayout.controls.ListControl" %>
<div class="box box-element ui-draggable" asp-uc="ListControl" asp-properties="Content">
