<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChannelListControl.ascx.cs" Inherits="WXLayout.controls.ChannelListControl" %>
<div class="box box-element ui-draggable" asp-uc="ChannelListControl" asp-properties="Content">
