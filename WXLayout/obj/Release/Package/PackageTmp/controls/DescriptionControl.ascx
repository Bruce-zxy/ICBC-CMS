<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DescriptionControl.ascx.cs" Inherits="WXLayout.controls.DescriptionControl" %>
<div class="box box-element ui-draggable" asp-uc="DescriptionControl" asp-properties="Content">
